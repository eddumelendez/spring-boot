...
package org.springframework.boot.testcontainers.service.connection.artemis;
...
class ArtemisContainerConnectionDetailsFactory
		extends ContainerConnectionDetailsFactory<Container<?>, ArtemisConnectionDetails> {
	...
	@Override
	protected ArtemisConnectionDetails getContainerConnectionDetails(ContainerConnectionSource<Container<?>> source) {
		return new ArtemisContainerConnectionDetails(source);
	}

	private static final class ArtemisContainerConnectionDetails extends ContainerConnectionDetails<Container<?>>
			implements ArtemisConnectionDetails {

		private ArtemisContainerConnectionDetails(ContainerConnectionSource<Container<?>> source) {
			super(source);
		}
		...
		public String getUser() {
			return getContainer().getEnvMap().get("ARTEMIS_USER");
		}

		@Override
		public String getPassword() {
			return getContainer().getEnvMap().get("ARTEMIS_PASSWORD");
		}
